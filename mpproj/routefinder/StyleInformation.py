# All climbing styles
climbing_styles = [
    'sport', 'trad', 'tr', 'boulder', 'mixed', 'aid', 'ice', 'snow']

# Climbing styles as presented to viewer
...
british_rating = [
    ...
    'E9 7b', 'E9 7b', 'E10 7b', 'E10 7b', 'E10 7c', 'E11 7c', 'E11 7c',
    'E11 7c', 'E11 8a', 'E11 8a', 'E11 8a', 'E11 8b', 'E11 8c', 'E11 8c']

hueco_rating  = [
    'V-easy', 'V0-', 'V0', 'V0+', 'V0-1', 'V1-', 'V1', 'V1+', 'V1-2', 'V2-',
    'V2', 'V2+', 'V2-3', 'V3-', 'V3', 'V3+', 'V3-4', 'V4-', 'V4', 'V4+',
    'V4-5', 'V5-', 'V5', 'V5+', 'V5-6', 'V6-', 'V6', 'V6+', 'V6-7', 'V7-',
    'V7', 'V7+', 'V7-8', 'V8-', 'V8', 'V8+', 'V8-9', 'V9-', 'V9', 'V9+',
    'V9-10', 'V10-', 'V10', 'V10+', 'V10-11', 'V11-', 'V11', 'V11+', 'V11-12',
    'V12-', 'V12', 'V12+', 'V12-13', 'V13-', 'V13', 'V13+', 'V13-14', 'V14-',
    'V14', 'V14+', 'V14-15', 'V15-', 'V15', 'V15+', 'V15-16', 'V16-', 'V16',
    'V16+', 'V16-17', 'V17-', 'V17']
...
mixed_rating = [
    'M0-', 'M0', 'M0+', 'M0-1', 'M1-', 'M1', 'M1+', 'M1-2', 'M2-', 'M2', 'M2+',
    'M2-3', 'M3-', 'M3', 'M3+', 'M3-4', 'M4-', 'M4', 'M4+', 'M4-5', 'M5-',
    'M5', 'M5+', 'M5-6', 'M6-', 'M6', 'M6+', 'M6-7', 'M7-', 'M7', 'M7+',
    'M7-8', 'M8-', 'M8', 'M8+', 'M8-9', 'M9-', 'M9', 'M9+', 'M9-10', 'M10-',
    'M10', 'M10+', 'M10-11', 'M11-', 'M11', 'M11+', 'M11-12', 'M12-', 'M12',
    'M12+', 'M12-13', 'M13-', 'M13', 'M13+', 'M13-14', 'M14-', 'M14', 'M14+',
    'M14-15']
